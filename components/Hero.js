  ...
  return (
    <div className="mb-5 max-w-2xl">
      ...
      <div className="mt-6 flex gap-6">
        <SocialLink
          href="https://github.com/selfmakeit"
          aria-label="Check out my Github"
          icon={IoLogoGithub}
        />
        <CopyToClipboard
          text={{ contact: 'c0ntac', type: 'Wechat' }}
          aria-label="Add me on wechat"
          icon={IoLogoWechat}
        />
        <CopyToClipboard
          text={{ contact: 'talktogang@gmail.com', type: 'Email' }}
          aria-label="Send me an email"
          icon={IoMail}
        />
        <CopyToClipboard
          text={{ contact: '+86 13088078435', type: 'Phone number' }}
